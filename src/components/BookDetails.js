        ...
        <div className='flex flex-col justify-center p-8 bg-white lg:p-16 lg:pl-10 lg:w-1/2'>
          ...
          <div className='flex items-center'>
            <a href={pdf && Object.values(pdf)[0]}>
              <button
                type='submit'
                className='inline-flex items-center justify-center h-12 px-6 mr-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-blue-400 hover:bg-orange-500 focus:outline-none'
              >
